...
class MembraneCurvature(AnalysisBase):
    ...
    def _single_frame(self):
        ...
        self.results.mean[self._frame_index] = mean_curvature(self.results.z_surface[self._frame_index], self.dy, self.dx)
        self.results.gaussian[self._frame_index] = gaussian_curvature(self.results.z_surface[self._frame_index], self.dy, self.dx)
